...
const Footer = () => {
  return (
    <footer className="bg-[#223055] text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-[#bcc9e6] text-lg mb-6 max-w-md">
              Platform belajar coding dan AI terbaik dalam bahasa Indonesia. 
              Mulai perjalanan tech mu bersama kami!
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-[#bcc9e6] hover:text-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#bcc9e6]">
              <li><a href="#" className="hover:text-accent transition-colors">Python</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">JavaScript</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Machine Learning</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">React</a></li>
        ...
        <div className="border-t border-[#3756a0] mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#bcc9e6] text-sm">
            © 2024 Sekolab. Semua hak dilindungi.
          </p>
          <p className="text-[#bcc9e6] text-sm mt-4 md:mt-0">
